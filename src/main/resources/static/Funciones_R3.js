    ...
    $.ajax({
        ...
        case 'Cloud':
            ...
            for(i=0;i<respuesta.length;i++){
                ...
                myTable+="<td>"+'<input readonly style="cursor: not-allowed;" type="text" id="categoryId" value='+respuesta[i].category?.name+' name="categoryId" class="w-full bg-white rounded border border-gray-300 text-base text-center outline-none text-gray-700 leading-8">' + "</td>";
                //myTable+="<td>";
        ...
        case 'Message':
            ...
            for(i=0;i<respuesta.length;i++){
                ...
                myTable+="<tr>";
                myTable+="<td>"+'<input readonly type="text" id="idMessage" style="cursor: not-allowed;" value='+respuesta[i].idMessage+' name="idMessage" class="w-full bg-white rounded border border-gray-300 text-center outline-none text-gray-700 leading-8"> </div>' + "</td>";
                ...
                myTable+="<td>"+'<input readonly style="cursor: not-allowed;" type="text" id="ClientId" value='+respuesta[i].client?.name+' name="ClientId" class="w-2/3 bg-white rounded border border-gray-300 text-base text-center outline-none text-gray-700 leading-8">' + "</td>";
                //myTable+="<td>";
                ...
                //myTable+="</td>";
                myTable+="<td>"+'<input readonly style="cursor: not-allowed;" type="text" id="CloudId" value='+respuesta[i].cloud?.name+' name="CloudId" class="w-2/3 bg-white rounded border border-gray-300 text-base text-center outline-none text-gray-700 leading-8">' + "</td>";
                //myTable+="<td>";
        ...
        case 'Reservation':
            ...
            for(i=0;i<respuesta.length;i++){
                ...
                myTable+="<tr>";
                myTable+="<td>"+'<input readonly type="text" id="idReservation" style="cursor: not-allowed;" value='+respuesta[i].idReservation+' name="idReservation" class="w-full bg-white rounded border border-gray-300 text-center outline-none text-gray-700 leading-8"> </div>' + "</td>";
                ...
                if(respuesta[i].score==null){myTable+="<td> Sin Calificar</td>";}else{myTable+="<td>"+respuesta[i].score?.score+"</td>"};
                myTable+="<td>"
                ...
                myTable+="<option value='created'>Programado</option>";
                myTable+="<option value='cancelled'>Cancelado</option>";
                myTable+="<option value='completed'>Realizado</option>";
                myTable+="</select>"
                myTable+="</td>"
                myTable+="</tr>"; 
                } 
...
function crearReg(tipo){
   ...
   var inicio = $("#startDate").val().substr(0,4)+$("#startDate").val().substr(5,2)+$("#startDate").val().substr(8,2)
   var fin = $("#devolutionDate").val().substr(0,4)+$("#devolutionDate").val().substr(5,2)+$("#devolutionDate").val().substr(8,2)
...
function listar(tipo){
    ...
    $.ajax({
        ...
        /*Opción 2
        let $select = $("#res_Select"+tipo);
        $.each(respuesta, funtion (id, name)){
